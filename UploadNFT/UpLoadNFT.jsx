  ...
  return (
    <div className={Style.upload}>
      ...
      <div className={Style.upload_box}>
        <div className={formStyle.Form_box_input}>
            ...
            <p className={formStyle.upload_box_input_para}>
              ...
              page, so that users can click to learn more about it. You are welcome to
      ...
      <div className={formStyle.Form_box_input}>
        ...
        cols="30" 
        rows="6"
        placeholder='semething about yourself in few words'
      ...
      <div className={formStyle.Form_box_input}>
       ...
       <div className={formStyle.Form_box_input_box_social}>
                <div className={formStyle.Form_box_input}>
            ...
            <div className={Style.upload_box_btn}>
              <Button btnName="Upload" handleClick={()=> {}} 
              classStyle={Style.upload_box_btn_style}/>
              <Button btnName="Preview" handleClick={()=> {}} 
              classStyle={Style.upload_box_btn_style}/>
            </div>
       </div>
    </div>
