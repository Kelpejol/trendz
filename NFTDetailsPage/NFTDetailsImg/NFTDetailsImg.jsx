    ...
    <div className={Style.NFTDetailsImg}>
      <div className={Style.NFTDetailsImg_box}>
        ...
        </div>
        {
            description && (
                <div className={Style.NFTDetailsImg_box_description}>
                    <p>Tattooed Kitty Gang("TKG") is a collection of 556 badass kitty gangsters, 
                        with symbol of tatooos, living in the proud kitty Gang ("PKG") metaverse.
                        Each TKG is an 1/1 ID as gangster member & all the joint rights. </p>
                </div>
            )
        }
        ...
        {details && (
            ...
            <p><small>Contract Address</small>
            <br />
            0x50f5474783983989389a
            </p>
